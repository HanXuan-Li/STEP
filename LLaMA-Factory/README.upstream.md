...
[24/04/22] Two Llama-3-derived models fine-tuned using LLaMA Factory are available at Hugging Face, check [Llama3-8B-Chinese-Chat](https://huggingface.co/shenzhi-wang/Llama3-8B-Chinese-Chat) and [Llama3-Chinese](https://huggingface.co/zhichen/Llama3-Chinese) for details.
...
- [Demo data collection](https://huggingface.co/datasets/llamafactory/demo_data)
...
- [Identity (en&zh)](https://huggingface.co/datasets/llamafactory/demo_data)
