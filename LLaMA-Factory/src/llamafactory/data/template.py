...
def get_template_and_fix_tokenizer(tokenizer: "PreTrainedTokenizer", data_args: "DataArguments") -> "Template":
    ...
    if data_args.default_system is not None:
        logger.info_rank0("Using a custom default system message (details omitted).")
...
register_template(
    ...
    default_system=(
        ...
        "For politically sensitive questions, security issues, "
...
register_template(
    ...
    default_system=(
        ...
        "security issues, and other non-computer science questions, you will refuse to answer.\n\n"
    ),
)
